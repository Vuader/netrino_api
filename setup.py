...
name = str('tachyonic_netrino_api')
sep = name.find('_')
namespace = name[:sep]
module = name[sep+1:]
...
setup_dict = dict(
    ...
    entry_points={
        # 'console_scripts': [
        #     'tachyonic_netrino_api_cli = tachyonic_netrino_api.main:entry_point'
        # ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'tachyonic_netrino_api_gui = tachyonic_netrino_api.gui:entry_point'
        # ]
    }
)
